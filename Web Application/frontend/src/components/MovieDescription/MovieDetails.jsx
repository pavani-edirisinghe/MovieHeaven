    ...
    <div className="movie-right">
      ...
      <div class="overview">
       ...
       <div class="details common-styles">
           ...
           <p>Show Date: <span class="release-date-value">{movieDetails.ShowDate}</span></p>
       </div>
